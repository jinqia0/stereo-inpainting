...
from core.dataset import TrainDataset, TrainDatasetStereo
...
class Trainer:
    ...
    def load(self):  # sourcery skip: low-code-quality
        """Load netG (and netD)."""
        ...
        if latest_epoch is not None:
            ...
            if gen_path is not None:
                ...
                print('Warning: There is no trained model found.'
    ...
    def _train_epoch(self, pbar):  # sourcery skip: low-code-quality
...
class TrainerStereo:
    def __init__(self, config):
        ...
        # setup data set and data loader
        self.train_dataset = TrainDatasetStereo(config['train_data_loader'])
